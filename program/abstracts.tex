...
\usepackage[pdfauthor={Testing Gravity 2017},pdftitle={Talk Abstracts},colorlinks,urlcolor={RegentGrey}]{hyperref}
...
\rhead{\fontspec{Lato Light Italic}\Large Talk Abstracts, page~\thepage}
\lfoot{}\cfoot{}\rfoot{}
...
\item \talk{Hartmut Abele (TUWien)}

\item \talk{Eric Adelberger (University of Washington)}
...
\item \talk{Bhuvnesh Jain (University of Pennsylvania)}

\item \talk{Austin Joyce (The University of Chicago)}
...
\item \talk{F\'elix-Louis JULI\'E (APC, Paris)}
To be confirmed.

\item \talk{Justin Khoury (University of Pennsylvania)}{Cosmic acceleration without wark energy}
...
\item \talk{Holger Muller (University of California Berkeley)}
...
\item \talk{Mark Trodden (University of Pennsylvania)}
