...
\item \talk{Eric Adelberger (University of Washington)}{Exotic spin-dependent interactions plus progress in lunar laser ranging}

I will discuss a set of torsion-balance experiments using electron-spin polarized test bodies that probe Planck-scale preferred frame effects, non-commutative geometries, pseudo-Goldstone bosons from new global symmetries, and ultra-low mass axion-like dark matter. I will finish by reviewing lunar-laser ranging in the APOLLO era.
